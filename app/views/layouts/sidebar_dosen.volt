...
<head>
  ...
  <link rel="icon" type="image/png" sizes="16x16" href='{{ url('../plugins/images/logo-its-biru.png') }}'>
  <title>Sistem Informasi Akademik ITS</title>
  <!-- Bootstrap Core CSS -->
  {{ stylesheet_link ('bootstrap/dist/css/bootstrap.min.css') }}
  <!-- Menu CSS -->
  {{ stylesheet_link ('plugins/bower_components/sidebar-nav/dist/sidebar-nav.css') }}
  <!-- animation CSS -->
  {{ stylesheet_link ('css/animate.css') }}
  <!-- Custom CSS -->
  {{ stylesheet_link ('css/style.css') }}
  <!-- color CSS -->
  {{ stylesheet_link ('css/colors/blue.css') }}
  <!-- Calendar CSS -->
  {{ stylesheet_link ('plugins/bower_components/calendar/dist/fullcalendar.css') }}
...
<body class="fix-header">
  ...
  <div id="wrapper">
      ...
      <div class="navbar-header">
        <div class="top-left-part">
          ...
          <a class="logo" href="index.html">
            <b><img src='{{ url('../plugins/images/logo-its-biru.png') }}' alt="home" height="49" width="80"/></b>
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
          <li class="dropdown">
            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src='{{ url('plugins/images/users/varun.jpg') }}' alt="user-img" width="36" class="img-circle"><b class="hidden-xs">Steave</b><span class="caret"></span> </a>
            <ul class="dropdown-menu dropdown-user animated flipInY">
              <li>
                <div class="dw-user-box">
                  <div class="u-img"><img src='{{ url('plugins/images/users/varun.jpg') }}' alt="user" /></div>
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                <li class="user-pro">
                    <a href="#" class="waves-effect" style="display: inline-block;"><img src='{{ url('plugins/images/users/varun.jpg') }}' alt="user-img" class="img-circle"> <span class="hide-menu">Nama Dosen</span><span class="hide-menu" style="display: inline-block;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NIP Dosen</span>
                    </a>
                ...
                <li> <a href="{{url("Homepage/mahasiswa")}}" class="waves-effect"><i class="mdi mdi-view-dashboard fa-fw" data-icon="v"></i> <span class="hide-menu">DASHBOARD<span></span></span></a>
                </li>
                ...
                <li> <a href="#" class="waves-effect"><i class="mdi mdi-archive fa-fw"></i> <span class="hide-menu">LAPORAN<span class="fa arrow"></span></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="{{url("SKEM/index")}}"><i class="ti-layout-width-default fa-fw"></i> <span class="hide-menu">SKEM</span></a></li>
                        <li><a href="{{url("SKPI/index")}}"><i class="ti-layout-sidebar-left fa-fw"></i> <span class="hide-menu">SKPI</span></a></li>
    ...
    <!-- ============================================================== -->
      ...
      {{ javascript_include ('js/slimscroll.js') }}
      <!-- Calendar JavaScript -->
      {{ javascript_include ('plugins/bower_components/moment/moment.js') }}
      {{ javascript_include ('plugins/bower_components/calendar/dist/fullcalendar.min.js') }}
      {{ javascript_include ('plugins/bower_components/calendar/dist/cal-init.js') }}
