                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Tambah Ruang</h4> </div>
                                  ...
                                  <div class="col-md-5 m-b-20">
                                    ...
                                    <div class="col-md-5 m-b-20">
                                      ...
                                      <select class="form-control" data-placeholder="Pilih Kuota" tabindex="1">
                                        <option value="Category 1">30</option>
                                        <option value="Category 2">35</option>
                                        <option value="Category 3">40</option>
                                        <option value="Category 4">50</option>
                                      </select> <span class="help-block"> Pilih Kuota. </span>
                                    </div>
                                    <div class="col-md-5 m-b-20">
                                      <label class="control-label">Tipe Ruang</label>
                                      <select class="form-control" data-placeholder="Pilih tipe ruang" tabindex="1">
                                        <option value="Category 1">kelas</option>
